...
def areaCirculo():
    ...
    while radio<=0:
        radio = float(inputNumber("El valor del radio no puede ser negativo ni cero, Por favor, ingrese el valor del radio del circulo: "))
...
def areaCuadrado():
    ...
    while lado <= 0:
        lado = float(inputNumber("El valor del lado no puede ser negativo ni cero, Por favor, ingrese el valor del lado del "
                           "cuadrado: "))
